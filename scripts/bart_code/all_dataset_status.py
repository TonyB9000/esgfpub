...
helptext = '''
    Usage:  all_dataset_status -s sproket_publication_report

        The all_dataset_status is produced by plying 3 sources to determine whether datasets exist
        in any of (Archive,Warehouse,Publication), hereafter (A,W,P).  Existence is determined by:
        ...
        (P):  The provided sproket_publication_report

        The sproket_publication_report is generated by running the scripts
...
def main():
    ...
    for atup in wh_nonempty:
        ...
        if not akey in dataset_status:  # first time we've encountered this experiment/case
            ...
            dataset_status[akey][dkey] = { 'A': False, 'W': True, 'P': False }
